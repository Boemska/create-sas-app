...
class AlertDialogs extends React.Component {
  ...
  render() {
    return (
      <Page renderToolbar={() => <CustomToolbar title={'Alert Dialogs'}/>}>
        <div className={'centered-text'}>
          <ListTitle>
            docs: <a href='https://onsen.io/v2/api/react/AlertDialog.html'>alert-docs-onsen</a>
          </ListTitle>
          <ListTitle>
            docs: <a href='https://onsen.io/v2/api/react/Toast.html'>toast-docs-onsen</a>
          </ListTitle>
          <ListTitle>
            docs: <a href='https://onsen.io/v2/api/react/Dialog.html'>dialog-docs-onsen</a>
          </ListTitle>
        </div>
